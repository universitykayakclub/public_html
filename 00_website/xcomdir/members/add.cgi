...
print <<"end_html1";
 ...
 <th>WAC<br>Fee<th>University<br>Status<th>Email<br>address<th>Email list
 <th>Address<th>ACA #
</tr>
end_html1
...
for ($i=1; $i<=$new; ++$i) {
 ...
 print qq(<td align=center><select name="type$i"><option selected>RS<option>L<option>I</select>\n);
 print qq(<td align=center><select name="wac$i"><option selected>no<option>paid</select>\n);
 print qq(<td align=center><select name="stat$i"><option selected>Student<option>Faculty/Staff<option>Spouse<option>Instructor</select>\n);
 print qq(<td align=center><input type="text" name="email$i" maxlength=30 size=10>\n);
 print qq(<td align=center><select name="list$i"><option value=1>no mail<option value=2 selected>ukc-all<option value=3>ukc-ww & ukc-all<option value=4>ukc-all & ukc-sea<option value=5>ukc-all, ukc-ww, & ukc-sea</select>);
 print qq(<td align=center><input type="text" name="address$i" maxlength=100 size=30>\n);
 print qq(<td align=center><input type="text" name="aca$i" maxlength=30 size=7>\n);
...
print<<"end_html2";
 ...
 <p>First and last names are required fields.  Others may be left blank.</p>
 <p>*Note: there's a new option under University Status. It's "Instructor" and is meant for people who no longer have an official association with UW, but have become Independent Instructors.</p>
 </center></body></html>
end_html2
