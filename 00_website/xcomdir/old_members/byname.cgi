...
open (BYNAME, "sort -t , -k 1 -k 2 $MEMBERS |");
@byname = <BYNAME>;
close BYNAME;
...
print <<"endnames";
 <HTML><HEAD><TITLE>Members by Name</TITLE></HEAD>
 ...
 <TH align=center>Student # <TH align=center>Join Date
...
foreach (@byname) {
 ...
 $date = join('/', $mo, $da, $yr);
 print "<TR><TD>$item[0] <TD>$item[1] <TD align=center>$item[2]
  <TD align=center>$date <TD align=center>$item[4]
